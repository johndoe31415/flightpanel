...
void simconnect_datadefs_register_instruments(void *hSimConnect, int group_id) {
	SimConnect_AddToDataDefinition(hSimConnect, group_id, "NAV IDENT", "ICAO code", SIMCONNECT_DATATYPE_STRING8);
	...
	SimConnect_AddToDataDefinition(hSimConnect, group_id, "ADF IDENT", "ICAO code", SIMCONNECT_DATATYPE_STRING8);
	...
	SimConnect_AddToDataDefinition(hSimConnect, group_id, "ADF ACTIVE FREQUENCY:1", "ADF Frequency BCD32", SIMCONNECT_DATATYPE_INT32);
