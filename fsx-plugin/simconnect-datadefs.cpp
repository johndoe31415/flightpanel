...
void simconnect_datadefs_register_instruments(void *hSimConnect, int group_id) {
	SimConnect_AddToDataDefinition(hSimConnect, group_id, "NAV IDENT", NULL, SIMCONNECT_DATATYPE_STRING8);
	...
	SimConnect_AddToDataDefinition(hSimConnect, group_id, "ADF IDENT", NULL, SIMCONNECT_DATATYPE_STRING8);
	...
	SimConnect_AddToDataDefinition(hSimConnect, group_id, "ADF ACTIVE FREQUENCY:1", "Frequency BCD32", SIMCONNECT_DATATYPE_INT32);
