...
void dump_instrument_data(FILE *f, const struct instrument_data_t *data) {
	fprintf(f, "COM1: %3d.%03d (%3d.%03d)     ", data->com1.freq_active_khz / 1000, data->com1.freq_active_khz % 1000, data->com1.freq_standby_khz / 1000, data->com1.freq_standby_khz % 1000);
	fprintf(f, "COM2: %3d.%03d (%3d.%03d)\n", data->com2.freq_active_khz / 1000, data->com2.freq_active_khz % 1000, data->com2.freq_standby_khz / 1000, data->com2.freq_standby_khz % 1000);
